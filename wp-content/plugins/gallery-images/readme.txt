...
Tags: gallery, image gallery, gallery image, content slider, widget gallery, lightbox gallery, website gallery, gallery lightbox, galleries, wordpress gallery, photo gallery, gallery, best gallery, content gallery, media gallery, gallery plugin, plugin gallery, add gallery, add image, add picture, add photo, portfolio, add images, add pictures, wp gallery, gallery slider, Galleria, simple gallery, wordpress gallery plugin, free gallery, video gallery, youtube gallery, photo albums, grid gallery, images gallery, filterable gallery, grid, photogallery, photoset, fullscreen gallery, justified, fullscreen slider, gallery shortcode, free photo gallery, best gallery plugin, photo album, image rotator, banner rotator, album, image album, wp gallery plugins, image gallery plugin, image slider, slideshow, slide, slideshow gallery, responsive gallery, gallery, multiple pictures, fotoalbum, photoalbum, justified gallery, pictures, picture, thumbnail gallery, slide show, responsive slideshow, gallery decription, thumbnails, image slideshow,
...
* Justified View - Image Gallery
* Blog Style View - Image Gallery

### Hundreds Of Design Options - Image Gallery
...
### Lightbox Popup With Many Options gallery - Image Gallery
...
**My images are resized within a view of Image Gallery, how to correct it?**
If you are pro user, then from General Options gallery go in Image Behavior and set on "Natural". If you are free user, just try to upload more proportional images for element box.
...
Add Images. Use the standard WordPress Image uploader to add an image from media library or upload from computer in “ Image Gallery “
Title. Add a title to your image in “ Image Gallery “
Description. give some information or describe the topic in “ Image Gallery “
URL. Provide some link of your post. Click to open in new tab or don’t click to open in the same tab in “ Image Gallery “
...
Image Randomize. Select to show your images randomly in “ Image Gallery “
...
Show Title. Choose to show the title or not in “ Image Gallery “

Element Title Font Size. Choose the font size for the title of the image / video in “ Image Gallery “

Element Title Font Color. Select preferable colour for the title of the image / video in “ Image Gallery “

Element Title Background Color. Choose the colour of title background in “ Image Gallery “

Element's Title Overlay Transparency. Select the level of transparency for the title overlay in “ Image Gallery “
