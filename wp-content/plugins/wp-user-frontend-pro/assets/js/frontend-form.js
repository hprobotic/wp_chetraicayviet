;(function($) {
    var WP_User_Frontend = {
        init: function() {
            ...
            $('.wpuf-form-add').on('click', 'img.wpuf-clone-field', this.cloneField);
            $('.wpuf-form-add').on('click', 'img.wpuf-remove-field', this.removeField);
            $('.wpuf-form-add').on('click', 'a.wpuf-delete-avatar', this.deleteAvatar);
            $('.wpuf-form-add').on('click', 'a#wpuf-post-draft', this.draftPost);
