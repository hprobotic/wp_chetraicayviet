...
class WPUF_Render_Form {
    ...
    function render_form( $form_id, $post_id = NULL, $preview = false ) {
        ...
        if ( $form_vars ) {
            ...
            <?php if ( !$preview ) { ?>
                ...
                <div class="wpuf-form form-horizontal">
    ...
    function text( $attr, $post_id, $type = 'post', $form_id = null ) {
        ...
        <div class="wpuf-fields col-md-8">
            <input class="form-control textfield<?php echo $this->required_class( $attr );  echo ' wpuf_'.$attr['name'].'_'.$form_id; ?>" id="<?php echo $attr['name']; ?>" type="text" data-required="<?php echo $attr['required'] ?>" data-type="text"<?php $this->required_html5( $attr ); ?> name="<?php echo esc_attr( $attr['name'] ); ?>" placeholder="<?php echo esc_attr( $attr['placeholder'] ); ?>" value="<?php echo esc_attr( $value ) ?>" size="<?php echo esc_attr( $attr['size'] ) ?>" <?php echo $username ? 'disabled' : ''; ?> />
    ...
    function textarea( $attr, $post_id, $type, $form_id ) {
        ...
        <?php if ( in_array( $attr['rich'], array( 'yes', 'teeny' ) ) ) { ?>
            <div class="wpuf-fields col-md-8 wpuf-rich-validation <?php printf( 'wpuf_%s_%s', $attr['name'], $form_id ); ?>" data-type="rich" data-required="<?php echo esc_attr( $attr['required'] ); ?>" data-id="<?php echo esc_attr( $attr['name'] ); ?>">
        <?php } else { ?>
            <div class="wpuf-fields col-md-8">
        <?php } ?>
            ...
            if ( $attr['rich'] == 'yes' ) {
                ...
                ?>
                <textarea class="form-control textareafield<?php echo $this->required_class( $attr ); ?> <?php echo ' wpuf_'.$attr['name'].'_'.$form_id; ?>" id="<?php echo $attr['name']; ?>" name="<?php echo $attr['name']; ?>" data-required="<?php echo $attr['required'] ?>" data-type="textarea"<?php $this->required_html5( $attr ); ?> placeholder="<?php echo esc_attr( $attr['placeholder'] ); ?>" rows="<?php echo $attr['rows']; ?>" cols="<?php echo $attr['cols']; ?>"><?php echo esc_textarea( $value ) ?></textarea>
            <?php } ?>
            <span class="wpuf-help"><?php echo stripslashes( $attr['help'] ); ?></span>
        </div>
    ...
    function radio( $attr, $post_id, $type, $form_id ) {
        ...
        <div class="wpuf-fields col-md-8" data-required="<?php echo $attr['required'] ?>" data-type="radio">
    ...
    function email( $attr, $post_id, $type = 'post', $form_id ) {
        ...
        <div class="wpuf-fields col-md-8">
            <input id="wpuf-<?php echo $attr['name']; ?>" type="email" class="email form-control <?php echo ' wpuf_'.$attr['name'].'_'.$form_id; ?>" data-required="<?php echo $attr['required'] ?>" data-type="text"<?php $this->required_html5( $attr ); ?> name="<?php echo esc_attr( $attr['name'] ); ?>" placeholder="<?php echo esc_attr( $attr['placeholder'] ); ?>" value="<?php echo esc_attr( $value ) ?>" size="<?php echo esc_attr( $attr['size'] ) ?>" />
            <span class="wpuf-help"><?php echo stripslashes( $attr['help'] ); ?></span>
        </div>
    ...
    function password( $attr, $post_id, $type, $form_id ) {
        ...
        <div class="col-md-8 wpuf-fields">

            <input id="pass1" type="password" class="form-control password <?php echo ' wpuf_'.$attr['name'].'_'.$form_id; ?>" data-required="<?php echo $attr['required'] ?>" data-type="text"<?php $this->required_html5( $attr ); ?> name="pass1" placeholder="<?php echo esc_attr( $attr['placeholder'] ); ?>" value="" size="<?php echo esc_attr( $attr['size'] ) ?>" />
            <span class="wpuf-help"><?php echo stripslashes( $attr['help'] ); ?></span>
        </div>
        ...
        if ( $attr['repeat_pass'] == 'yes' ) {
            ...
            <div class="col-md-4 wpuf-fields">
                <input id="pass2" type="password" class="form-control password <?php echo ' wpuf_'.$attr['name'].'_'.$form_id; ?>" data-required="<?php echo $attr['required'] ?>" data-type="text"<?php $this->required_html5( $attr ); ?> name="pass2" value="" size="<?php echo esc_attr( $attr['size'] ) ?>" />
            </div>
        ...
        if ( $attr['repeat_pass'] == 'yes' && $attr['pass_strength'] == 'yes' ) {
            ?>
            <div class="col-md-4 wpuf-fields">
                <div id="pass-strength-result"><?php _e( 'Độ mạnh mật khẩu' ); ?></div>
    ...
    function repeat( $attr, $post_id, $type, $form_id ) {
        ...
        ?>
<div class="col-md-12">
        <div class="wpuf-fields repeat-field <?php echo ' wpuf_'.$attr['name'].'_'.$form_id; ?>">
    ...
    function taxonomy( $attr, $post_id, $form_id ) {
        ...
        <?php if ( $attr['type'] == 'checkbox' ) { ?>
            <div class="wpuf-fields col-md-8 <?php echo $div_class; ?>" data-required="<?php echo esc_attr( $attr['required'] ); ?>" data-type="tax-checkbox">
        <?php } else { ?>
            <div class="wpuf-fields col-md-8 <?php echo $div_class; ?>">
        <?php } ?>
    ...
    function html( $attr, $form_id ) {
        ?>
        <div class="wpuf-fields col-md-8 <?php echo ' wpuf_'.$attr['name'].'_'.$form_id; ?>">
    ...
    function toc( $attr, $post_id, $form_id ) {
        ...
        <div data-required="yes" data-type="radio" class="wpuf-fields col-md-8 <?php echo ' wpuf_'.$attr['name'].'_'.$form_id; ?>">

            <textarea class="form-control" rows="10" cols="40" disabled="disabled" name="toc"><?php echo $attr['description']; ?></textarea>
            <label>
    ...
    function section_break( $attr, $post_id, $form_id ) {
        ?>
        <div class="col-md-12 wpuf-form">
        <div class="wpuf-section-wrap <?php echo ' wpuf_'.$attr['name'].'_'.$attr['id'].'_'.$form_id; ?>">
            <h2 class="reg-block-title"><?php echo $attr['label']; ?></h2>
    ...
    function date( $attr, $post_id, $type, $form_id ) {
        ...
        <div class="wpuf-fields col-md-8">
            <input id="wpuf-date-<?php echo $attr['name']; ?>" type="text" class="datepicker form-control <?php echo ' wpuf_'.$attr['name'].'_'.$form_id; ?>" data-required="<?php echo $attr['required'] ?>" data-type="text"<?php $this->required_html5( $attr ); ?> name="<?php echo esc_attr( $attr['name'] ); ?>" value="<?php echo esc_attr( $value ) ?>" size="30" />
            <span class="wpuf-help"><?php echo stripslashes( $attr['help'] ); ?></span>
        </div>
        <script type="text/javascript">
            jQuery(function($) {
